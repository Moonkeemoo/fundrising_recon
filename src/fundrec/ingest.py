...
def run_ingest(
    ...
    *,
    ...
    # --- Collect + Extract (Campaigns as primary, Cases optionally) ---
    stored_campaigns = 0
    stored_cases = 0
    ...
    for url in discovered_urls:
        ...
        # --- Mandatory correction 2: write raw cache ---
        ...
        # --- Mandatory correction 1: extract CAMPAIGN (primary) ---
        ...
        # Store partners first (FK dependency)
