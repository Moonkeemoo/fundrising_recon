...
_THEME_KEYWORDS: dict[str, list[str]] = {
    ...
    "recon": ["розвідуваль", "розвідник", "крило", "autel", "автел", "розвідк"],
    "bombers": ["бомбер", "важкий дрон", "вампір", "баба яга", "нічний дрон"],
    "reb_ew": ["реб", "антидрон", "глушилк", "радіоелектрон", "ew", "купол"],
    "vehicles": ["авто", "пікап", "буханк", "транспорт", "баггі", "машин",
                 "мікроавтобус", "позашляховик", "евакуац"],
    "nrk_demining": ["нрк", "наземн", "роботизован", "розмінуван", "кнро"],
    "comms": ["starlink", "старлінк", "зв'язк", "звʼязк", "рація", "рації",
              "ретранслятор", "антена"],
    "optics_thermal": ["тепловізор", "приціл", "монокуляр", "бінокл",
                       "нічного бачення", "пнб", "планшет"],
    "body_armor": ["бронежилет", "плитоноск", "рпс", "шолом", "каск",
                   "екіпір", "розвантаж", "берц"],
    "medical": ["медиц", "тактмед", "аптечк", "турнікет", "ноші", "бинт",
                "кровоспин", "медбат"],
    "ammo": ["боєприпас", "набої", "гранат", "мінометн"],
    "energy": ["генератор", "павербанк", "енергет", "зарядн", "акумулятор"],
    "camouflage": ["маскув", "сітк", "кікімор", "фортифікац", "бліндаж"],
    "fuel": ["пальне", "паливо", "бензин", "дизель"],
    "fiber": ["оптоволокн", "оптичн", "на оптиці"],
    "3d_print": ["3д-друк", "3d-друк", "3д друк", "друк деталей"],
